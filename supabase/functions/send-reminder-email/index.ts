      ...
      setTimeout(async () => {
        ...
        try {
          const emailResponse = await resend.emails.send({
            from: "MedMate <onboarding@resend.dev>",
            to: [email],
          ...
          console.log('Medicine reminder email sent successfully:', emailResponse);
        } catch (emailError) {
          console.error('Failed to send medicine reminder email:', emailError);
        }
      }, delay);
    } else {
